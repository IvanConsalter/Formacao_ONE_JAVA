...
props.load(new FileReader("conf.properties"));<br>

String login = props.getProperty("login");<br>
String senha = props.getProperty("senha");<br>
String endereco = props.getProperty("endereco");<br>

System.out.println(login + ", " + senha  + ", " +  endereco);<br>
